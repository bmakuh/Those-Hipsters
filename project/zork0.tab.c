...
{
  "$end", "error", "$undefined", "MOTION", "DIRECTION", "AGGRESSION",
  "HAZARD", "CONSUMPTION", "FOOD", "EXIT", "$accept", "game", "actionList",
  "action", "moveType", "fightType", "eatType", 0
};
#endif
